package com.springpj.heroesuserservice.errorhandler;

import com.springpj.heroesuserservice.errorhandler.exception.AuthenticationFailedException;
import com.springpj.heroesuserservice.errorhandler.exception.NotFoundException;
...
public class GlobalExceptionHanlder extends ResponseEntityExceptionHandler{
	...
	private ErrorResponse.ErrorResponseBuilder composeErrorResponseBuilder(Exception e, HttpStatus status){
